$(".showtitle").each(function(i,t){
		...
		if($("[name='"+$(t).prop('id')+"']").is('select'))
			$("[name='"+$(t).prop('id')+"']").parent().html($(t).text());
		else if(type=='radio') {
		...
		else if($("[name='"+$(t).prop('id')+"']").is('label')) $("[id='"+$(t).prop('id')+"']").parent().html($("[id='"+$(t).prop('id')+"']").text());
		
		else if(type=='number') {
			$("[name='"+$(t).prop('id')+"']").parent().html($("[name='"+$(t).prop('id')+"']").val());
		}
		...
		else $("[name='"+$(t).prop('id')+"']").parent().html($(t).html().replace(/font-family:\w+;?/ig,'').replace(/font-family: \w+;?/ig,''));
