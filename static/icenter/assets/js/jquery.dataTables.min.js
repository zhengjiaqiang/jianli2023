    ...
    var L = function(h) {
        var j = function(e) {
            ...
            function ja(a, b) {
                ...
                var currPage = Math.ceil(a._iDisplayStart / a._iDisplayLength) + 1;
                var totlePage = Math.ceil(a.fnRecordsDisplay() / a._iDisplayLength);
                return b.replace(/_PAGE_/g, currPage).replace(/_NUM_/g, a._iDisplayLength).replace(/_PAGES_/g, totlePage).replace(/_START_/g, c).replace(/_END_/g, d).replace(/_TOTAL_/g, i).replace(/_MAX_/g, f)
            }
            function ba(a) {
