...
jQuery.validator.addMethod("mobilePhone", function(value, element) {
    var length = value.length;
    var mobile = /^(((1[0-9]{2})+\d{8})|((0[0-9]{2,3}\-)?([2-9][0-9]{6,7})+(\-[0-9]{1,4})?))$/
...
$.validator.addMethod("selectNone", function(value, element) {
    var emp = /^请选择$/;
    return this.optional(element) || (emp.test(value)); 
}, "必须选择一项");
//验证密码
...
var chrnum = /^(([1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3})|([1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}(\d|X|x)))$/;
    return this.optional(element) || (chrnum.test(value));
}, "身份证号码错误");
...
var upload_reg = /\.(jpg|jpeg|gif|png)/i;            
                if ($.trim(value) == "") {
                    return true;
                }
                return upload_reg.test($.trim(value));
            },
            "上传图片后缀必须为(jpg|jpeg|gif|png)"
        );