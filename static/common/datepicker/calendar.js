...
function My97DP() {
    ...
    $d.innerHTML = "<div id=dpTitle><div style=\"float:left\" class=\"navImg NavImgll\"><a href=\"###\" style=\"\"></a></div><div style=\"float:left\" class=\"navImg NavImgl\"><a href=\"###\" style=\"\"></a></div><div style=\"float:left\"><div class=\"menuSel MMenu\" style=\"z-index:1\"></div><input class=yminput tabindex=1></div><div style=\"float:left\"><div class=\"menuSel YMenu\" style=\"z-index:1\"></div><input class=yminput tabindex=2></div><div style=\"float:right\" class=\"navImg NavImgrr\"><a href=\"###\" style=\"\"></a></div><div style=\"float:right\" class=\"navImg NavImgr\"><a href=\"###\" style=\"\"></a></div></div><div style=\"position:absolute;overflow:hidden\"></div><div></div><div id=dpTime><div class=\"menuSel hhMenu\" style=\"z-index:1\"></div><div class=\"menuSel mmMenu\" style=\"z-index:1\"></div><div class=\"menuSel ssMenu\" style=\"z-index:1\"></div><table cellspacing=0 cellpadding=0 border=0><tr><td rowspan=2><span id=dpTimeStr></span><input class=tB maxlength=2 tabindex=3><input value=\":\" class=tm readonly><input class=tE maxlength=2 tabindex=4><input value=\":\" class=tm readonly><input class=tE maxlength=2 tabindex=5></td><td><button id=dpTimeUp></button></td></tr><tr><td><button id=dpTimeDown></button></td></tr></table></div><div id=dpQS></div><div id=dpControl><input class=dpButton id=dpClearInput type=button tabindex=6> <input class=dpButton id=dpTodayInput type=button tabindex=7> <input class=dpButton id=dpOkInput type=button tabindex=8></div>";
    attachTabEvent($d,
    function() {
        hideSel()
    });
...
My97DP.prototype = {
    init: function() {
        ...
        function($) {
            if ($dp.el == ($.srcElement || $.target)) {
                ...
                if (k == 9) if (!$dp.cal.checkAndUpdate()) {
    ...
    _fm: function() {
        //this._fHMS("m", 6, "i * 10 + j +1")
		$d["mD"].innerHTML = this._f("m", 8 , 8, "i * 8 + j +0")
    },
    _fs: function() {
        this._fHMS("s", 1, "j * 10")
    },
    _fillQS: function(A) {
        ...
        $.a("</td></tr>");
        for (var B = 0; B < this.QS.length; B++) if (this.QS[B]) {
            $.a("<tr><td style=\"text-align:left\" nowrap='nowrap' class='menu' onmouseover=\"this.className='menuOn'\" onmouseout=\"this.className='menu'\" onmousedown=\"");
    ...
    autoSize: function() {
        ...
        for (var _ = 0; _ < $.length; _++) if ($[_].contentWindow == window) {
            $[_].style.width = $d.offsetWidth+5 + "px";
            $[_].style.height = $d.offsetHeight+5 + "px"
        }
    },
    ...
    initQS: function() {
        ...
        else for (H = 0; H < $ * 2; H++) C[H] = $dt[_] - $ + 1 + H;
        for (H = G = 0; H < E; H++) {
