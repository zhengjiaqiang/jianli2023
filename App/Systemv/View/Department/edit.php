	...
	<body class="diy-css">
		<form id="edit-form-area" name="edit-form-area" class="form-horizontal mcms" role="form" method="post" action="__SELF__">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 科室名称 </label>
				<div class="col-sm-9">
					<?php html::text('name',get_array_val($info,'name'),array('class'=>'col-xs-10 col-sm-5','placeholder'=>'科室名称')); ?>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 科室code </label>
				<div class="col-sm-9">
					<?php html::text('code',get_array_val($info,'code'),array('class'=>'col-xs-10 col-sm-5','placeholder'=>'科室code')); ?>
				</div>
			</div>
			
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 科室排序 </label>
				<div class="col-sm-9">
					<?php html::text('sort',get_array_val($info,'sort'),array('class'=>'col-xs-10 col-sm-5','placeholder'=>'科室排序')); ?>
				</div>
			</div>
