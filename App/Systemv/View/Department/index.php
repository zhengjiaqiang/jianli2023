...
<body class="diy-css list-fixed" id="layer-open-parent">
	<div class="list-siderbar">
		<div class="opr-btns">
			...
			<if condition="$delete"> 
				<button type="button" class="btn btn-primary" data-stitle="确定删除当前科室？" role-e="delete" data-loading-text="删除中..."><i class="icon icon-remove"></i> 删除已选项</button>
			</if>
		...
		<table id="main-table-frist" class="table table-striped table-bordered table-hover">
			<thead>
				<tr>
					...
					<th class="left">科室名称</th>
					<th width="120" class="fc">科室代码</th>
					<th width="60">排序</th>
					<th width="120">操作</th>
				</tr>
			</thead>
			...
			MCMS.table.Init(onePageRow,controller+'/index?id='+pid,[
					...
					{   "aTargets": [0],
						...
						"mRender": function (data, type, full) { 
							...
							if(del){
								_h+='<a class="red " title="删除" href="javascript:void(0);" data-id="'+full.id+'" data-stitle="确定删除当前科室？" role="delete"  data-loading-text="删除中..."><i class="icon-trash bigger-130"></i>  删除</a></div>';
							}
                          return _h;
                        }
					}
