			...
			MCMS.table.Init(onePageRow,controller+'/index?id='+pid,[
					...
					{   "aTargets": [0],
						...
						"mRender": function (data, type, full) { 
							...
							if(del){
								_h+='<a class="red" title="删除" href="javascript:void(0);" data-id="'+full.id+'" data-stitle="确定删除当前邮件模板？" role="delete"  data-loading-text="删除中..."><i class="icon-trash bigger-130"></i>  删除</a></div>';
							}
                          return _h;
                        }
					}
