			  	...
			  	<tbody>
				  	<tr>
				    	<td align="center" valign="center">
					        ...
					        <button type="button" class="btn btn-yellow btn-sm" lay-submit lay-filter="setresume">确定</button>
					        <button type="button" class="btn btn-purple btn-sm" lay-submit lay-filter="submitresume">批量操作</button>
				    	</td>
				  	</tr>
				  	<tr height="10"></tr>
				</tbody>
