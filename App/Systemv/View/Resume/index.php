		...
		<table id="main-table-frist" class="table table-striped table-bordered table-hover">
			<thead>
				<tr>
					...
					<th width="80">生源地/出生地</th>
					<th width="120">年龄</th>
					<th width="60">学历</th>
					<th width="60" class="fc">毕业学校</th>
					<th width="60">专业</th>
					<th width="60">实习/工作经历(单位)</th>
					<th width="30">排序</th>
					<th width="120">操作</th>
				</tr>
			</thead>
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			MCMS.table.Init(onePageRow,controller+'/index?id='+pid+"&type="+_type,[
					...
					__i("province",null,false),
					__i("education",null,false),
					__i("graduateSchool",null,false),
					__i("major",null,false),
					__i("practiceWorkUnits",null,false),
					<if condition="$type eq 2">
					__i("id",0,false),</if>
					__i("id",0,false),
					__i("id",0,false)
                ...
                { "aTargets": [2],
					...
					{
						"aTargets": [<if condition="$type eq 2">18<else/>12</if>],
						"mRender": function (data, type, full) { 
							return '<input type="text" name="sort['+full.id+']" value="'+full.sort+'" style="width:70px;" class="input"/>';
						}
					},
					{
						"aTargets": [<if condition="$type eq 2">19<else/>13</if>],
						"mRender": function (data, type, full) { 
