	...
	<body class="diy-css">
		<form id="edit-form-area" name="edit-form-area" class="form-horizontal mcms" role="form" method="post" action="__SELF__">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<?php html::text('name',get_array_val($info,'name'),array('class'=>'col-xs-10 col-sm-5','placeholder'=>'姓名')); ?>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 科室 </label>
				<div class="col-sm-9">
					<?php html::text('department',get_array_val($info,'department'),array('class'=>'col-xs-10 col-sm-5','placeholder'=>'科室')); ?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<?php html::text('email',get_array_val($info,'email'),array('class'=>'col-xs-10 col-sm-5','placeholder'=>'邮箱')); ?>
				</div>
			</div>
