			...
			MCMS.table.Init(onePageRow,controller+'/index?id='+pid,[
					...
					{   "aTargets": [0],
						...
						"mRender": function (data, type, full) { 
							...
							if(del){
								_h+='<a class="red " title="删除" href="javascript:void(0);" data-id="'+full.id+'" role-stitle="确定删除吗？" role="delete"  data-loading-text="删除中..."><i class="icon-trash bigger-130"></i>  删除</a></div>';
							}
                          return _h;
                        }
					}
